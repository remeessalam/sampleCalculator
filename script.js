...
class Calculator {
    ...
    appendNumber(number) {
        ...
        console.log(this.currentOperand, 'this is current operand number')
    }
    ...
    updateDisplay() {
        ...
        if (this.operation != null) {
            this.preivousOperandTextElement.innerText =
                `${this.getDisplayNumber(this.previousOperand)} ${this.operation}`
        } else {
            this.preivousOperandTextElement.innerText = this.previousOperand
        }
    }
}
